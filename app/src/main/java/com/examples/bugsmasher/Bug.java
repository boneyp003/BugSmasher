...
public class Bug {
    ...
    public void birth (Canvas canvas) {
        ...
        // Check if bug is alive yet
            ...
            if (curTime - startBirthTimer >= timeToBirth) {
                ...
                speedMultiplier = (new Random()).nextInt(8 - 4 + 1) + 4;
                speed = canvas.getHeight() / 10 * speedMultiplier; // no faster than 1/4 a screen per second
    ...
    public void move (Canvas canvas) {
        ...
        if (state == BugState.Alive) {
            ...
            long currentTime = System.currentTimeMillis() /100 % 10;
            if(currentTime % 2 == 0)
                canvas.drawBitmap(Assets.ant1, x-Assets.ant1.getWidth()/2,  y-Assets.ant1.getHeight()/2, null);
            else
                canvas.drawBitmap(Assets.ant2, x-Assets.ant2.getWidth()/2,  y-Assets.ant2.getHeight()/2, null);
            ...
            if (y >= canvas.getHeight()) {
                ...
                // Subtract 1 life
                Assets.livesLeft--;
                Assets.soundPool.play(Assets.sound_looselife,1,1,1,0,1);
            }
        }
    }
